      ...
      ****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT O_RPT5000 ASSIGN TO RPT5000.
	   ...
	   01 SALESREP-TOTALS.
	       05 ST-THIS-YTD            PIC S9(9)V99 VALUE ZERO.
		   05 ST-LAST-YTD            PIC S9(9)V99 VALUE ZERO.
		   05 ST-CHANGE              PIC S9(9)V99 VALUE ZERO.
       ...
       220-PROCESS-CUSTOMER-RECORD.
           ...
           IF WS-CURRENT-SALESREP NOT = WS-PREVIOUS-SALESREP
               PERFORM 455-PRINT-SALESREP-LINE 
               PERFORM 415-CLEAR-SALESREP-TOTALS
	   ...
	   355-PRINT-SALESREP-LINE 
		   ...
		   WRITE PRINT-AREA 
		   IF ST-LAST-YTD NOT = ZERO
		       COMPUTE WS-CHANGE-PERCENT = (ST-CHANGE / ST-LASTLYTP) *100
		   ELSE 
		       MOVE 999.9 TO WS-CHANGE-PERCENT
		   END-IF 
		   
		   MOVE ST-THIS-YTD TO STL-THIS
		   MOVE ST-LAST-YTD TO STL-LAST 
		   MOVE ST-CHANGE TO STL-CHANGE 
